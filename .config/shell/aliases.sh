...
alias gi='cd $GOPATH/src/github.com/giantswarm/giantswarm'
...
alias vi='nvim'
alias bln='kubectl neat | bat -lyaml'
alias bl='bat -lyaml'
alias watch='watch '
alias please='sudo'
alias hell='helm'
alias switch-theme="switch-theme.sh; source ~/.config/shell/theme.sh"
alias yv='ln -fsv "$(echo -e "/usr/bin/yq\n/home/theo/.local/bin/yq_mikefarah"|fzf)" ~/.local/bin/yq'
